          ...
          <div className="grid w-full grid-cols-1 gap-2 sm:grid-cols-[auto_minmax(12rem,1fr)] lg:grid-cols-[auto_minmax(14rem,1fr)_minmax(20rem,24rem)] lg:items-center">
            <button
              ...
              className={`flex min-h-11 items-center justify-center gap-2 px-4 py-2.5 rounded-full border text-sm font-bold transition-all shadow-sm backdrop-blur-sm ${
                showTaskTabs
                  ? 'bg-[var(--text-on-primary)] text-primary border-[var(--text-on-primary)]'
                  : 'bg-[rgba(var(--text-on-primary-rgb),0.1)] text-[var(--text-on-primary)] border-[rgba(var(--text-on-primary-rgb),0.2)] hover:bg-[rgba(var(--text-on-primary-rgb),0.2)]'
              }`}
            ...
            <div className="relative min-w-0">
              ...
              <input 
                ...
                className="min-h-11 pl-9 pr-4 py-2.5 rounded-full bg-[rgba(var(--text-on-primary-rgb),0.1)] border border-[rgba(var(--text-on-primary-rgb),0.2)] text-[var(--text-on-primary)] placeholder-[rgba(var(--text-on-primary-rgb),0.6)] text-sm focus:border-[var(--text-on-primary)] focus:ring-2 focus:ring-[rgba(var(--text-on-primary-rgb),0.3)] outline-none w-full transition-all shadow-sm backdrop-blur-sm"
              />
            </div>
            
            <div className="relative grid min-h-11 grid-cols-3 items-center gap-1 overflow-hidden bg-[var(--card-bg)]/95 backdrop-blur-sm border border-[rgba(var(--text-on-primary-rgb),0.24)] rounded-full p-1 w-full shadow-sm sm:col-span-2 lg:col-span-1">
              <div
          ...
          <div className="flex flex-wrap items-center gap-2">
                ...
                >
                  <button
                    ...
                    className={`flex min-h-9 min-w-0 max-w-full items-center gap-2 rounded-full px-3.5 py-2 text-sm font-bold transition-all shadow-none ${
                      isActiveList
                        ? 'bg-primary text-[var(--text-on-primary)] shadow-sm'
                  ...
                  >
                    ...
                    <span className={`shrink-0 text-[11px] leading-none px-2 py-1 rounded-full ${
                      isActiveList
                        ? 'bg-[rgba(var(--text-on-primary-rgb),0.18)] text-[var(--text-on-primary)]'
                  ...
                  {isListTab && listId && (
                    ...
                    >
                      <button
                        ...
                        className={`grid min-h-8 w-8 place-items-center rounded-full bg-primary/10 text-primary hover:bg-primary hover:text-[var(--text-on-primary)] transition-all duration-300 shadow-none ${
            ...
            <div className="flex min-w-0 flex-1 basis-full items-center gap-2 sm:basis-64 lg:basis-72">
              ...
              <button
                ...
                className="grid min-h-9 w-9 shrink-0 place-items-center rounded-lg bg-primary/10 text-primary hover:bg-primary hover:text-[var(--text-on-primary)] transition-all shadow-none"
                title="Add new list"
              >
                <Plus size={16} />
              </button>
          ...
          {editingListId && (
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 px-2 py-2 bg-primary/5 rounded-2xl">
              ...
              <button
                ...
                className="min-h-9 px-4 py-2 bg-primary text-[var(--text-on-primary)] text-sm rounded-xl hover:bg-primary-hover transition-all shadow-none"
              >
                Save
              </button>
              <button
