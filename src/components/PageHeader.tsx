...
const PageHeader = ({ title, subtitle, children, align = 'start' }: PageHeaderProps) => (
  <header className={`bg-primary -mx-4 md:-mx-8 -mt-4 md:-mt-8 mb-6 px-6 md:px-12 pt-12 pb-14 md:pb-16 arch-bottom shadow-lg shadow-primary/20 relative overflow-hidden flex flex-col items-${align} gap-6`}>
