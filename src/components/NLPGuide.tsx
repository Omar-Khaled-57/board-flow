  ...
  return (
    <>
      <button
        ...
        className="absolute end-4 top-1/2 -translate-y-1/2 text-primary opacity-80 hover:opacity-100 drop-shadow-[0_0_8px_var(--color-primary)] transition-all p-1 rounded-full"
      ...
      {isOpen && (
        <div className="absolute top-full end-0 mt-2 w-80 bg-(--card-bg) border border-(--border-color) rounded-xl shadow-xl p-4 z-50 animate-in fade-in slide-in-from-top-2">
